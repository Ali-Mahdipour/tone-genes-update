---
title: "Tone and genes: new data and methods support the negative effect of *ASPM* but not of *Microcephalin*"
...
cairo_pdf("./figures/map_genes.pdf", width=10, height=4);
...
plot(dag_tone_genes);
impliedConditionalIndependencies(dag_tone_genes);
```
...
```{r fig.cap=capFig("Distribution of binary tone.")}
pander(tmp <- table(d_tb$tone_binary));

distrib_all <- ggplot(as.data.frame(tmp), aes(x="Whole database", y=Freq, fill=Var1)) +
  theme_bw() +
...
pander(tmp <- table(d_tb$tone_binary, d_tb$macroarea));
...
```{r fig.cap=capFig("Relationship between tone binary (colors) and the two genes (frequency) by macroarea."), fig.width=2*5, fig.height=2*3.2}
...
plot_tone1_genes_p1 <- ggplot(tmp, aes(x=ASPM_freq_wavg, y=MCPH1_freq_wavg)) + xlim(0,1) + ylim(0,1) + 
...
plot_tone1_genes_p2 <- ggplot(tmp, aes(x=ASPM_freq_wavg, fill=tone_binary)) + xlim(0,1) +
...
plot_tone1_genes_p3 <- ggplot(tmp, aes(x=MCPH1_freq_wavg, fill=tone_binary)) + xlim(0,1) +
  geom_jitter(aes(y=tone_binary, shape=tone_binary), alpha=0.50, color="black") + 
  geom_violin(aes(y=tone_binary), alpha=0.35, color="black") + 
  geom_boxplot(aes(y=tone_binary), alpha=0.35, color="black") + 
...
grid.arrange(plot_tone1_genes_p1, plot_tone1_genes_p2, plot_tone1_genes_p3, nrow=3);
```
...
cairo_pdf("./figures/tone1_genes.pdf", width=5*2.5, height=3*2.75);
grid.arrange(plot_tone1_genes_p1, plot_tone1_genes_p2, plot_tone1_genes_p3, nrow=3);
dev.off();
```
...
- the interactions drop out: there does not seem to be an interaction between the two genes (`r sprintf("*p* = %.2g", anova(m_tb_full_old, m_tb_1)[2,"Pr(>Chisq)"])`), nor between the genes and macroarea  (`r sprintf("*p* = %.2g", anova(m_tb_full_old, m_tb_2)[2,"Pr(>Chisq)"])`);
...
We use here only the numerically-coded version.
...
grid.arrange(ggplot(reshape::melt(sem_samples_per_fam[,c("Afr_aspm_b", "Afr_mcph1_b", "Afr_tone_b", "aspm_tone_b", "mcph1_tone_b")]),
               ...
               scale_fill_discrete(name="Paths", labels=c("Afr_aspm_b"=expression("Africa " %->% " ASPM"), "Afr_mcph1_b"=expression("Africa " %->% " MCPH1"), "Afr_tone_b"=expression("Africa " %->% " tone"), "aspm_tone_b"=expression("ASPM " %->% " tone"), "mcph1_tone_b"=expression("MCPH1 " %->% " tone"))) + 
             ...
             ggplot(reshape::melt(sem_samples_per_fam[,c("Afr_aspm_p", "Afr_mcph1_p", "Afr_tone_p", "aspm_tone_p", "mcph1_tone_p")]),
               ...
               scale_fill_discrete(name="Paths", labels=c("Afr_aspm_p"=expression("Africa " %->% " ASPM"), "Afr_mcph1_p"=expression("Africa " %->% " MCPH1"), "Afr_tone_p"=expression("Africa " %->% " tone"), "aspm_tone_p"=expression("ASPM " %->% " tone"), "mcph1_tone_p"=expression("MCPH1 " %->% " tone"))) + 
...
The distribution of **complex tone** is:

```{r fig.cap=capFig("Distribution of complex tone.")}
pander(tmp <- table(d_t3$tone_complex));

distrib_all <- ggplot(as.data.frame(tmp), aes(x="Whole database", y=Freq, fill=Var1)) +
  theme_bw() +
  geom_bar(stat="identity", color="black", alpha=0.25) + 
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Complex tone") + ylab("Count") + 
...
pander(tmp <- table(d_t3$tone_complex, d_t3$macroarea));
...
```{r fig.cap=capFig("Relationship between complex tone (colors) and the two genes (frequency) by macroarea."), fig.width=2*5, fig.height=2*3.2}
...
plot_tone2_genes_p1 <- ggplot(tmp, aes(x=ASPM_freq_wavg, y=MCPH1_freq_wavg)) + xlim(0,1) + ylim(0,1) + 
  xlab(expression(italic("ASPM")-"D")) + ylab(expression(italic("MCPH1")-"D")) +
...
plot_tone2_genes_p2 <- ggplot(tmp, aes(x=ASPM_freq_wavg, fill=tone_complex)) + xlim(0,1) +
...
plot_tone2_genes_p3 <- ggplot(tmp, aes(x=MCPH1_freq_wavg, fill=tone_complex)) + xlim(0,1) +
  geom_jitter(aes(y=tone_complex, shape=tone_complex), alpha=0.50, color="black") + 
  geom_violin(aes(y=tone_complex), alpha=0.35, color="black") + 
  geom_boxplot(aes(y=tone_complex), alpha=0.35, color="black") + 
...
grid.arrange(plot_tone2_genes_p1, plot_tone2_genes_p2, plot_tone2_genes_p3, nrow=3);
```
...
cairo_pdf("./figures/tone2_genes.pdf", width=5*2.5, height=3*2.75);
grid.arrange(plot_tone2_genes_p1, plot_tone2_genes_p2, plot_tone2_genes_p3, nrow=3);
dev.off();
```
...
- the interactions drop out: there does not seem to be an interaction between the two genes (`r sprintf("*p* = %.2g", anova(m_t3_full, m_t3_1)[2,"Pr(>Chisq)"])`), nor between the genes and macroarea  (`r sprintf("*p* = %.2g", anova(m_t3_full_old, m_t3_2)[2,"Pr(>Chisq)"])`);
...
Thus, it seems that there is a *qualitative difference* between *ASPM* and *MCPH1*: while for both there are positive and comparably strong total (TE) and direct (ADE) effects, only *ASPM* shows a clearly positive indirect effect (ACME).
Moreover, being in Africa or not has a much stronger effect (*β* Africa → gene) on *MCPH1* than on *ASPM*, and the partial effect of the gene on tone (after controlling for Africa, *β* gene → tone | Africa) is clearly negative only for *ASPM*.
...
- the path Africa → complex tone is basically 0: `r sprintf("mean = %.2g, median = %.2g, sd = %.2g, IQR = %.2g, %.1f%% > 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), median(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$Afr_tone_b > 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$Afr_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$Afr_tone_b, mu=0, alternative="greater"))$parameter, tt$statistic, tt$p.value)`;

- the path *ASPM* → complex tone is negative: `r sprintf("mean = %.2g, median = %.2g, sd = %.2g, IQR = %.2g, %.1f%% < 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), median(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$aspm_tone_b < 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$aspm_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$aspm_tone_b, mu=0, alternative="less"))$parameter, tt$statistic, tt$p.value)`;

- the path *MCPH1* → complex tone tends slightly to be negative: `r sprintf("mean = %.2g, median = %.2g, as = %.2g, IQR = %.2g, %.1f%% < 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), median(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$mcph1_tone_b < 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$mcph1_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$mcph1_tone_b, mu=0, alternative="less"))$parameter, tt$statistic, tt$p.value)`.

Thus, again, there is a negative effect of *ASPM* on complex tone, there is no effect of being in Africa or not, but possibly a negative one for *MCPH1*.
...
The distribution of tone **counts** is:

```{r fig.cap=capFig("Distribution of tone counts.")}
pander(tmp <- table(d_tc$n_tones));

distrib_all <- ggplot(as.data.frame(tmp), aes(x=Var1, y=Freq, fill=Var1)) +
  theme_bw() +
  geom_bar(stat="identity", color="black", alpha=0.25) + 
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Tone count") + ylab("Count") + 
  scale_fill_viridis_d("Tone count") + theme(legend.position="top") + ggtitle("World") + 
  NULL;

pander(tmp <- table(d_tc$n_tones, d_tc$macroarea));
...
distrib_africa <- ggplot(tmp[ tmp$Var2 == "Africa", ], aes(x=Var1, y=Freq, fill=Var1)) +
  ...
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Tone count") + ylab("Count") + 
  scale_fill_viridis_d("Tone count") + theme(legend.position="none") + ggtitle("Africa") + 
  NULL;
...
distrib_eurasia <- ggplot(tmp[ tmp$Var2 == "Eurasia", ], aes(x=Var1, y=Freq, fill=Var1)) +
  ...
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Tone count") + ylab("Count") + 
  scale_fill_viridis_d("Tone count") + theme(legend.position="none") + ggtitle("Eurasia") + 
  NULL;
...
distrib_america <- ggplot(tmp[ tmp$Var2 == "America", ], aes(x=Var1, y=Freq, fill=Var1)) +
  ...
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Tone count") + ylab("Count") + 
  scale_fill_viridis_d("Tone count") + theme(legend.position="none") + ggtitle("America") + 
  NULL;
...
distrib_papunesia <- ggplot(tmp[ tmp$Var2 == "Papunesia", ], aes(x=Var1, y=Freq, fill=Var1)) +
  ...
  geom_text(aes(label=Freq), color="black", position = position_stack(vjust = 0.5), size=3.0)+
  xlab("Tone count") + ylab("Count") + 
  scale_fill_viridis_d("Tone count") + theme(legend.position="none") + ggtitle("Papunesia") + 
  NULL;
...
```{r fig.cap=capFig("Relationship between tone counts (colors) and the two genes (frequency) by macroarea."), fig.width=2*5, fig.height=2*3.2}
...
plot_tone2_genes_p2 <- ggplot(tmp, aes(x=ASPM_freq_wavg, fill=n_tones)) + xlim(0,1) +
...
plot_tone2_genes_p3 <- ggplot(tmp, aes(x=MCPH1_freq_wavg, fill=n_tones)) + xlim(0,1) +
  geom_jitter(aes(y=n_tones), alpha=0.50, color="black") + 
  geom_violin(aes(y=n_tones), alpha=0.35, color="black") + 
  geom_boxplot(aes(y=n_tones), alpha=0.35, color="black") + 
...
cairo_pdf("./figures/tone_counts_genes.pdf", width=5*2.5, height=3*2.75);
grid.arrange(plot_tone2_genes_p1, plot_tone2_genes_p2, plot_tone2_genes_p3, nrow=3);
dev.off();
```
...
# ASPM:
p1 <-ggplot(perm_res_tc_glmer[ perm_res_tc_glmer$permute != "nothing", ], aes(x=ASPM_b)) + xlab("β") + xlim(-10,10) + 
  geom_density(aes(fill=permute, color=permute), alpha=0.5) + 
  geom_vline(data=perm_res_tc_glmer[ perm_res_tc_glmer$permute == "nothing", c("macroarea", "ASPM_b", "MCPH1_b")], aes(xintercept=ASPM_b), color="black", linetype="dashed") + 
  geom_vline(xintercept=0.0, color="black", linetype="dotted") + 
  facet_grid(macroarea ~ permute_within, scales="free_y") + theme(legend.position = "top") + 
  scale_fill_discrete("What is permuted:") + scale_color_discrete("What is permuted:");
# MCPH1:
p2 <- ggplot(perm_res_tc_glmer[ perm_res_tc_glmer$permute != "nothing", ], aes(x=MCPH1_b)) + xlab("β") + xlim(-10,10) + 
  geom_density(aes(fill=permute, color=permute), alpha=0.5) + 
  geom_vline(data=perm_res_tc_glmer[ perm_res_tc_glmer$permute == "nothing", c("macroarea", "ASPM_b", "MCPH1_b")], aes(xintercept=MCPH1_b), color="black", linetype="dashed") + 
  geom_vline(xintercept=0.0, color="black", linetype="dotted") + 
  facet_grid(macroarea ~ permute_within, scales="free_y") + theme(legend.position = "none");
...
tmp$model <- factor(as.character(tmp$model), 
                    ...
                    labels=c("by itself", "ctrl macroarea", "ctrl macroarea & the other allele", "by itself", "ctrl macroarea", "ctrl macroarea & the other allele"));
ggplot(tmp, aes(x=beta, fill=model)) + 
  geom_density(alpha=0.25) + geom_vline(xintercept=0.0, color="black", linetype="dotted") + xlab("β") +
  facet_wrap(. ~ gene, scales="free_y", labeller=label_bquote(italic(.(gene))-"D")) +
  theme(legend.position="bottom") + scale_fill_discrete(name="Model");
dev.off();
```
...
```{r fig.height=2*4, fig.width=3*4, fig.cap=capFig(paste0("Mediation analysis for ",n_samples," restricted samples (i.e., picking one random language per family). The leftmost panels show the distribution of point estimates of the Total Effect (TE), the Direct Effect (ADE) and the Indirect Effect (ACME) for *ASPM* and *MCHP1*; the middle panels show the distribution of the *p*-values for the same effects, while the rightmost panels show the distribution of the regression slopes (*β*) for the two genes, top: for the regression of the gene frequency on within vs outside Africa, and bottom: for the regression of tone on the gene while controlling for within vs outside Africa. The black vertical lines show: 0.0 (dotted), 0.05 (solid) and 0.10 (dashed)."))}
p1 <- ggplot(reshape::melt(med_samples_per_fam[,c("aspm_TE", "aspm_ADE", "aspm_ACME")]),
...
Thus, it is a *qualitative difference* between *ASPM* and *MCPH1*: while for both there are positive and comparably strong total (TE) and direct (ADE) effects, only *ASPM* shows a clearly positive indirect effect (ACME).
Moreover, being in Africa or not has a much stronger effect (*β* Africa → gene) on *MCPH1* than on *ASPM*, and the partial effect of the gene on tone (after controlling for Africa, *β* gene → tone | Africa) is clearly negative only for *ASPM*.
This is also supported by the significance of the individual mediation analyses, but given the low sample size *N* = `r length(unique(d_tb$family_name))` unique families, relatively few effect sizes are big enough to be significant; however, even here, there are many more significant indirect effects (ACME) for *ASPM* than for *MCPH1*: `r sprintf("%.1f%% vs %.1f%% (%.1f times) for *α*-level 0.05, and %.1f%% vs %.1f%% (%.1f times) for *α*-level 0.10", 100*sum(med_samples_per_fam$aspm_gene_tone_p < 0.05,na.rm=TRUE)/nrow(med_samples_per_fam), 100*sum(med_samples_per_fam$mcph1_gene_tone_p < 0.05,na.rm=TRUE)/nrow(med_samples_per_fam), sum(med_samples_per_fam$aspm_gene_tone_p < 0.05,na.rm=TRUE)/sum(med_samples_per_fam$mcph1_gene_tone_p < 0.05,na.rm=TRUE), 100*sum(med_samples_per_fam$aspm_gene_tone_p < 0.10,na.rm=TRUE)/nrow(med_samples_per_fam), 100*sum(med_samples_per_fam$mcph1_gene_tone_p < 0.10,na.rm=TRUE)/nrow(med_samples_per_fam), sum(med_samples_per_fam$aspm_gene_tone_p < 0.10,na.rm=TRUE)/sum(med_samples_per_fam$mcph1_gene_tone_p < 0.10,na.rm=TRUE))`!
...
- the path Africa → number of tones is positive: `r sprintf("mean = %.2g, median = %.2g, sd = %.2g, IQR = %.2g, %.1f%% > 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), median(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$Afr_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$Afr_tone_b > 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$Afr_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$Afr_tone_b, mu=0, alternative="greater"))$parameter, tt$statistic, tt$p.value)`;

- the path *ASPM* → number of tones is negative: `r sprintf("mean = %.2g, median = %.2g, sd = %.2g, IQR = %.2g, %.1f%% < 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), median(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$aspm_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$aspm_tone_b < 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$aspm_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$aspm_tone_b, mu=0, alternative="less"))$parameter, tt$statistic, tt$p.value)`;

- the path *MCPH1* → number of tones is basically 0: `r sprintf("mean = %.2g, median = %.2g, as = %.2g, IQR = %.2g, %.1f%% < 0; %.1f%% significant at *α*-level 0.05; one-sample one-sided *t*-test vs 0: *t*(%d) = %.2g, *p* = %.2g", mean(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), median(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), sd(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), IQR(sem_samples_per_fam$mcph1_tone_b, na.rm=TRUE), 100*sum(sem_samples_per_fam$mcph1_tone_b < 0, na.rm=TRUE)/nrow(sem_samples_per_fam), 100*sum(sem_samples_per_fam$mcph1_tone_p < 0.05, na.rm=TRUE)/nrow(sem_samples_per_fam), (tt <- t.test(sem_samples_per_fam$mcph1_tone_b, mu=0, alternative="less"))$parameter, tt$statistic, tt$p.value)`.

Thus, again, there is a negative effect of *ASPM* on number of tones, there is a positive effect of being in Africa, but no effect for *MCPH1*.
